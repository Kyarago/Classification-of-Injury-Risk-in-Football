...
# --------------- df_1_5_iqr_df0 ---------------
df_1_5_iqr_df0 = pd.read_csv('C:/Users/aurim/Desktop/Mokslai/df_1_5_iqr_df0.csv', low_memory=False)
df_1_5_iqr_df0 = df_1_5_iqr_df0.drop(['Minutes played', 'height'], axis=1)

df1=df_1_5_iqr_df0[df_1_5_iqr_df0['Injury condition']==1]
df0=df_1_5_iqr_df0[df_1_5_iqr_df0['Injury condition']==0]
del df_1_5_iqr_df0

# Prepare the dat for k-means
...
plt.savefig('C:/Users/aurim/Desktop/Mokslai/Undersampled Data/df_1_5_iqr_df0/CH_df_1_5_iqr_df0.pdf',
            bbox_inches="tight")
plt.close()
...
plt.legend()
plt.show()
plt.savefig('C:/Users/aurim/Desktop/Mokslai/Undersampled Data/df_1_5_iqr_df0/PCA_df_1_5_iqr_df0.pdf',
            bbox_inches="tight")
plt.close()
...
plt.xlabel('Number of Clusters')
plt.ylabel('Calinski-Harabasz Score')
plt.savefig('C:/Users/aurim/Desktop/Mokslai/Undersampled Data/df_1_5_iqr_df0/CH_df_1_5_iqr_df0_pca.pdf',
            bbox_inches="tight")
plt.close()
...
for label in np.unique(cluster_labels):
    ...
    summary_stats.to_csv(f'C:/Users/aurim/Desktop/Mokslai/Undersampled Data/df_1_5_iqr_df0/EXP_cluster_{label}_df_1_5_iqr_df0.csv')
...
for column, y_label, title in zip(columns_to_plot, y_labels, titles):
    ...
    plt.savefig(f'C:/Users/aurim/Desktop/Mokslai/Undersampled Data/df_1_5_iqr_df0/BP_Cluster_{column}_df_1_5_iqr_df0.pdf',
                bbox_inches="tight")
    plt.close()
...
df_1_5_iqr_df0_UND = pd.concat([df0_thinned, df1])
df_1_5_iqr_df0_UND.to_csv('C:/Users/aurim/Desktop/Mokslai/Undersampled Data/df_1_5_iqr_df0/df_1_5_iqr_df0_UND.csv',
                   index=False)

# Balance of classes in percentage:
print(df_1_5_iqr_df0_UND['Injury condition'].value_counts())
print(df_1_5_iqr_df0_UND['Injury condition'].value_counts(normalize=True) * 100)
